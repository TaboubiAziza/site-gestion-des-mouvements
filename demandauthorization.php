...
<head>
  ...
  <title>Request an authorization</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="demandauthorization.php" class="logo"><img src="TUTunisair.png"> <span class="lite">Request an authorization</span></a>
      <!--logo end-->
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa fa-bars"></i> Authorization Form</h3>
        ...
        <div class="row">
          ...
          <div class="recent">
            ...
            <form action="addauth.php" method="post" role="form" class="contactForm">
  
            <div class="form-group">
              
                <input type="time" class="form-control" name="from" data-msg="from" id="from" placeholder="From" required/>
                <div class="validation"></div>
              </div>
              <div class="form-group">
                <input type="time" class="form-control" name="to" data-msg="to" id="to" placeholder="To" required/>
                <div class="validation"></div>
              </div>
              <div class="form-group">
                <textarea class="form-control" name="description" rows="5" data-rule="required" data-msg="description." placeholder="More specifications about your request."></textarea>
                <div class="validation"></div>
              </div>
              
              <div class="text-center"><button type="submit" class="btn btn-primary btn-lg">Send Demand</button></div>
            </form>
          </div>
