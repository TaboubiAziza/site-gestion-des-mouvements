...
<head>
  ...
  <title>Authorization request history</title>
...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><img src="TUTunisair.png"> <span class="lite">Authorization demand history</span></a>
      <!--logo end-->
      ...
      <section class="wrapper">
        <div class="row">
          ...
          <p style="text-align: left;">
               <a  href="demandauthorization.php" class="user"> 
               <button type="button" class="btn btn-success"  title='Send Request' > 
                <i class="fas fa-file-signature"></i>
               </button></a>
              </p>
              <p style="text-align: right;">
           <u><b> Authorization Balance: </b> <?php 
           include_once 'conn.php';
           $req = "SELECT authorizationbalance FROM user WHERE user.matricule = '" . $_SESSION["matricule"] . "'";
           $myquery = mysqli_query($conn, $req);
           $row = mysqli_fetch_array($myquery);
           $authorizationbalance = $row['authorizationbalance'];
           echo $authorizationbalance ;
           ?> hours.</u>
           </p>
            <section class="panel">
            ...
            <div class="table-responsive">
              <table class="table table-striped table-advance table-hover" id="table">
                ...
                <tbody>
                  <?php
                   include_once 'conn.php';
                   $req="SELECT authorization.id, authorization.from, authorization.to, authorization.description, authorization.status, authorization.date FROM authorization, user WHERE authorization.matricule = user.matricule AND user.matricule = '" . $_SESSION["matricule"] . "' ";
                   $myquery = mysqli_query($conn, $req);
                   ...
                   while ($row = mysqli_fetch_array($myquery)) {
                     ...
                     <a class='btnDelete' href='suppauth.php?id=".$row['id']."'>
